...
STRING(SELECT_WASM_MOD, "Select wasm module...")
...
STRING(WASM_MOD_DIRECTORY_NOT_FOUND, "Wasm modules directory not found.\n(default path: 0:/gm9/%s)")
STRING(HOME_LANGUAGE_MENU_SELECT_LANGUAGE, "HOME language... menu.\nSelect language:")
STRING(HOME_SCRIPTS_MENU_SELECT_SCRIPT, "HOME scripts... menu.\nSelect script:")
STRING(HOME_SCRIPTS_MENU_SELECT_WASM_MOD, "HOME wasm... menu.\nSelect wasm module:")
